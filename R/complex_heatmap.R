	...
	complex_heatmap <- function (data_mat, metadata, property, n_genes, clustering_method="Pearson correlation", type="Fit in Screen") {
		...
		if(!is.null(property)) {
			...
			expr_data_in <- data_mat[1:n_genes,,drop=F]
